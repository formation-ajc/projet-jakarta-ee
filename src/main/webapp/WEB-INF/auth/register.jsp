...
<body>
    <div class="dark auth vh-100 vw-100 d-flex justify-content-center align-items-center">
        ...
        <form action="<% out.print(request.getContextPath()); %>/register" method="POST" class="dark-secondary connection-card p-5 d-flex gap-3 justify-content-center align-items-center flex-column rounded-3">
            <span style="font-size: 50px" class="material-symbols-outlined text-white">app_registration</span>
            <div class="h3 text-white">Please sign up</div>
            <div class="input-group flex-nowrap">
<%--                <span class="input-group-text material-symbols-outlined" id="Email">alternate_email</span>--%>
                <input name="firstname" type="text" class="form-control white" placeholder="Firstname" aria-label="Firstname" aria-describedby="addon-wrapping">
            </div>
            <div class="input-group flex-nowrap">
                <%--                <span class="input-group-text material-symbols-outlined" id="Email">alternate_email</span>--%>
                <input name="lastname" type="text" class="form-control white" placeholder="Lastname" aria-label="Lastname" aria-describedby="addon-wrapping">
            </div>
            <div class="input-group flex-nowrap">
            ...
            <div class="input-group flex-nowrap">
                <span class="neutral input-group-text material-symbols-outlined" id="ConfirmPassword">lock</span>
            ...
            <div class="d-flex gap-2 justify-content-center align-items-center w-100">
                <a class="white d-flex align-items-center justify-content-center btn btn-light border-0" href="<% out.print(request.getContextPath()); %>/login">
                    <span class="material-symbols-outlined">
                        chevron_left
                    </span>
                </a>
                <button type="submit" class="btn btn-primary w-100 text-white blue border-0 h-100">Sign up</button>
            </div>
        </form>
    </div>
</body>
