...
<body>
	<div class="container mt-5">
		<div class="row justify-content-center" >
			<h2 class="mb-3 text-center text-light mb-3">Edit Recipe</h2>
			<div class="col-md-8 border p-5 bg-light text-light rounded">
				<form action="<% out.print(request.getContextPath()); %>/editRecipe" method="POST">
					...
					<input type="text" name="name" class="form-control mb-2" value="${rec.name }" placeholder="nom">
					<c:if test="${!empty form.errors['name'] }">
						<p class="text-danger">${ form.errors['name']}"</p>
					</c:if>
					<textarea name="description" rows="5" class="form-control mb-2" placeholder="Ecrivez une description"><c:out value="${rec.description }"/></textarea>
